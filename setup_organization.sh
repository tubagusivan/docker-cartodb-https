...
echo "INSERT INTO feature_flags (id,name, restricted) VALUES (nextval('machine_added_feature_flags_id_seq'), 'editor-3', false);" | psql -U postgres carto_db_production && \
echo "INSERT INTO feature_flags (id,name, restricted) VALUES (nextval('machine_added_feature_flags_id_seq'), 'explore_site', false);" | psql -U postgres carto_db_production && \

ORGANIZATION_NAME="qlue"
USERNAME="admin"
EMAIL="admin@qlue.id"
PASSWORD="qluesmartcity13"
